  ...
  const onUpload = async (imageList) => {
    try {
      ...
      const uploadResponse = await axios.post(
        "http://localhost:5001/save-image",
        formData,
        {
          headers: {
      ...
      // Store the uploaded image path in localStorage
      if (uploadResponse.data.filePath) {
        localStorage.setItem("uploadedImage", uploadResponse.data.filePath);
      }
      ...
      if (uploadResponse.data.similar_images) {
        localStorage.setItem(
          "similarImages",
          JSON.stringify(uploadResponse.data.similar_images)
        );
      }
    ...
    <div className="image-manager">
          ...
          <div className="row">
            <div className="col-lg-10 offset-lg-1">
              <div className="header-text">
                <h2>
                  Discover Similar <em>Images</em> &amp; Enhance Your Search
                  with <em>Relevance Feedback</em>
                </h2>
                <p>
                  Our application empowers you to upload, manage, and search
                  images with precision. Easily find similar images using
                  content-based retrieval methods and refine your results with
                  relevance feedback.
                </p>
                ...
                >
                  <div className="about-right-content">
                    <div className="section-heading">
                      ...
                      <h4>
                        what <em>ImageMatch</em> can do
                      </h4>
                      <div className="line-dec"></div>
                    </div>
                    <p>
                      The goal of this web application is to implement basic
                      image indexing and search functionalities based on
                      content. The application enables image uploads,
                      organization by categories, and the creation of new images
                      through transformations like cropping and scaling.
                    </p>
                    <p>
                      The system also supports searching for similar images
                      based on various descriptors such as color, texture, and
                      shape, leveraging advanced feature re-weighting methods
                      for relevance.
                    </p>
                  </div>
                </div>
      ...
      <div className="responsive-container-block outer-container">
        <div className="responsive-container-block inner-container">
          <p className="text-blk section-head-text">Meet Our Project Team</p>
